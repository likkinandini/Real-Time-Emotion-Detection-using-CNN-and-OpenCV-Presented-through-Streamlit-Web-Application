...
# Define sign labels
label = ['Happy', 'Happy', 'Happy', 'Happy', 'Happy','Happy']
...
def main():
    ...
    with col2:
        use_webcam = st.checkbox('Check Your Emotion', value=False, key='checkbox')
    ...
    if use_webcam:
        ...
        st.write('Click "Check Your Emotion" to activate the webcam.')
